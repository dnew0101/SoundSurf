...
1. wasm/audio_processor.c + Makefile — compile with emcc to get audio_processor.wasm into client/public/wasm/. This is your critical path; nothing else can be tested end-to-end without it.
